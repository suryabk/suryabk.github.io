    ...
    <section className="bg-costum-dark-variant pt-8 mx-auto h-full">
      <div className="container mx-auto h-full flex flex-col">
        <div className="my-4 md:my-8">
          <Fade direction="left" delay={500} duration={1000} triggerOnce={true}>
      ...
      <Fade direction="right" delay={500} duration={1000} triggerOnce={true}>
      ...
      <div className="my-8 flex justify-center flex-wrap gap-y-8 gap-x-8 w-full text-4xl">
        <Fade direction="up" duration={750} cascade={true} triggerOnce={true}>
